#!/bin/bash
# This script installs Website Services on DigitalOcean Drupal instance.
...
printf "${Green}Installing Website Services...${Color_Off}\n"
...
printf "\n${Green}Open http://$IP/core/install.php to proceed with Website Services installation.${Color_Off}\n"
